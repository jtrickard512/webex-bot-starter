...
let faq3 = 'The survey will close end of day on Friday, March 26th. You may receive a few reminders between now and then.'
...
app.post('/realdeal', webhook(framework));
